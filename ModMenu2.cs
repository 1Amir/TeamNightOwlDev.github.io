...
public class ModMenu2 : MonoBehaviour {
    ...
    public static float BoxPositionAssistX = 0;
    ...
    public static float MenuResizex05ButtonX = 0;
    ...
    private static void ModMenu()
    {
        ...
        if (IsOpen)
        {
            ...
            GUI.backgroundColor = Color.black;
            GUI.Box(new Rect(40 + BoxPositionAssistX, 140 - BoxPositionAssistY, 700 - BoxResizeAssistWidth, 600 - BoxResizeAssistHeight), "");
            GUI.Box(new Rect(40 + BoxPositionAssistX, 140 - BoxPositionAssistY, 700 - BoxResizeAssistWidth, 600 - BoxResizeAssistHeight), "<size=" + MenuResize + 0.5f + "><color=cyan>Made With <3 By @ITS_N1GH7OWL\nCreated For IOSGODS.COM</color></size>");
            /*All Buttons Below*/
            ...
            //x0.5
            if (GUI.Button(new Rect(660 - MenuResizex05ButtonX, 40 + MenuResizex1x2x3ButtonY, MenuResize + 96 - ButtonResize, MenuResize + 96 - ButtonResize), "<color=white><size=" + MenuResize + 0 + ">x0.5</size></color>"))
            {
                MenuResize = 1;
                ButtonResize = 50;
                ButtonResizeAssistHeightRowOne = 155;
                ButtonResizeAssistHeightRowTwo = 210;
                ButtonResizeAssistHeightRowThree = 265;
                ButtonResizeAssistHeightRowFour = 320;
                ButtonResizeAssistHeightRowFive = 375;
                ...
                MenuResizex05ButtonX = 270;
                MenuResizex1x2x3ButtonY = -40;
                MenuResizeDefaultButton = 216f;
                BoxPositionAssistY = 95;
            }
            //x1
            ...
            if (GUI.Button(new Rect(460 - MenuResizex3ButtonX, 40 + MenuResizex1x2x3ButtonY, MenuResize + 96 - ButtonResize, MenuResize + 96 - ButtonResize), "<color=white><size=" + MenuResize + 0 + ">x3</size></color>"))
            {
                ...
                MenuResizex05ButtonX = 130;
                MenuResizex1x2x3ButtonY = 0;
                MenuResizeDefaultButton = 104f;
                BoxPositionAssistY = 26;
            }
            //Default
            if (GUI.Button(new Rect(560 - MenuResizeDefaultButton, 40 + MenuResizex1x2x3ButtonY, MenuResize + 96 - ButtonResize, MenuResize + 96 - ButtonResize), "<color=white><size=" + MenuResize + 0 + ">x4</size></color>"))
            {
                MenuResize = 4;
                ButtonResize = 0;
